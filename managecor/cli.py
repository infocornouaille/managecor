...
CONFIG_URL = "https://raw.githubusercontent.com/infocornouaille/managecor/main/config.yaml"
...
def create_aliases(aliases):
    ...
    typer.echo(f"Aliases added to {rc_file}. Please restart your shell or run 'source {rc_file}' to apply changes.")
